...
class GE2ELossV2(nn.Module):

    def __init__(self, init_w=10.0, init_b=-5.0, loss_method='softmax', **kwargs):
        '''
        ...
        '''
        super(GE2ELossV2, self).__init__()
    ...
    def forward(self, dvecs, label=None):
        ...
        device = dvecs.get_device()

        gsize = dvecs.size()[1]
        stepsize = dvecs.size()[0]
