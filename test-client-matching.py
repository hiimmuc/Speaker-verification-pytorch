...
#                 print(c)
#                 get_response(refs, [c])
    coms = ['log_service/unknown/Chau Anh (tin tuc).m4a', 
            'log_service/unknown/Chau Anh (tong dai).m4a', 
            'log_service/unknown/Master Hoai Thu.wav', 
            'log_service/unknown/Master Huyen Trang.wav', 
            'log_service/unknown/Master Thuy Linh.wav'] 
    for c in  coms:
