    ...
    def __init__(self, inplanes, planes, dsp, up_path, gate, stride=1, dilation=1):
        ...
        if self.dsp:
            ...
            if self.up_path:
                ...
                self.conv2_u = nn.Conv1d(bottel_plane_split, bottel_plane_split, 
                ...
                if self.gate: 
                    self.gate_moduel = Gate_module(planes, planes //3, nb_input = 3)
            else: 
                if self.gate: 
                    self.gate_moduel = Gate_module(planes, planes //2, nb_input = 2)
