...
class RepVGG(nn.Module):
    ...
    def __init__(self, num_blocks, nOut=1000, width_multiplier=None, override_groups_map=None, deploy=False, use_se=False, n_mels=64):
        ...
        self.stage0 = RepVGGBlock(in_channels=1, out_channels=self.in_planes,
...
def create_RepVGG_A0(nOut=256,  deploy=False):
    return RepVGG(num_blocks=[2, 4, 14, 1], nOut=nOut,
                  width_multiplier=[0.75, 0.75, 0.75, 2.5], override_groups_map=None, deploy=deploy)


def create_RepVGG_A1(nOut=256,  deploy=False):
    return RepVGG(num_blocks=[2, 4, 14, 1], nOut=nOut,
                  width_multiplier=[1, 1, 1, 2.5], override_groups_map=None, deploy=deploy)


def create_RepVGG_A2(nOut=256,  deploy=False):
    return RepVGG(num_blocks=[2, 4, 14, 1], nOut=nOut,
                  width_multiplier=[1.5, 1.5, 1.5, 2.75], override_groups_map=None, deploy=deploy)


def create_RepVGG_B0(nOut=256,  deploy=False):
    return RepVGG(num_blocks=[4, 6, 16, 1], nOut=nOut,
                  width_multiplier=[1, 1, 1, 2.5], override_groups_map=None, deploy=deploy)


def create_RepVGG_B1(nOut=256,  deploy=False):
    return RepVGG(num_blocks=[4, 6, 16, 1], nOut=nOut,
                  width_multiplier=[2, 2, 2, 4], override_groups_map=None, deploy=deploy)


def create_RepVGG_B1g2(nOut=256,  deploy=False):
    return RepVGG(num_blocks=[4, 6, 16, 1], nOut=nOut,
                  width_multiplier=[2, 2, 2, 4], override_groups_map=g2_map, deploy=deploy)


def create_RepVGG_B1g4(nOut=256,  deploy=False):
    return RepVGG(num_blocks=[4, 6, 16, 1], nOut=nOut,
                  width_multiplier=[2, 2, 2, 4], override_groups_map=g4_map, deploy=deploy)


def create_RepVGG_B2(nOut=256,  deploy=False):
    return RepVGG(num_blocks=[4, 6, 16, 1], nOut=nOut,
                  width_multiplier=[2.5, 2.5, 2.5, 5], override_groups_map=None, deploy=deploy)


def create_RepVGG_B2g2(nOut=256,  deploy=False):
    return RepVGG(num_blocks=[4, 6, 16, 1], nOut=nOut,
                  width_multiplier=[2.5, 2.5, 2.5, 5], override_groups_map=g2_map, deploy=deploy)


def create_RepVGG_B2g4(nOut=256,  deploy=False):
    return RepVGG(num_blocks=[4, 6, 16, 1], nOut=nOut,
                  width_multiplier=[2.5, 2.5, 2.5, 5], override_groups_map=g4_map, deploy=deploy)


def create_RepVGG_B3(nOut=256,  deploy=False):
    return RepVGG(num_blocks=[4, 6, 16, 1], nOut=nOut,
                  width_multiplier=[3, 3, 3, 5], override_groups_map=None, deploy=deploy)


def create_RepVGG_B3g2(nOut=256,  deploy=False):
    return RepVGG(num_blocks=[4, 6, 16, 1], nOut=nOut,
                  width_multiplier=[3, 3, 3, 5], override_groups_map=g2_map, deploy=deploy)


def create_RepVGG_B3g4(nOut=256,  deploy=False):
    return RepVGG(num_blocks=[4, 6, 16, 1], nOut=nOut,
                  width_multiplier=[3, 3, 3, 5], override_groups_map=g4_map, deploy=deploy)


def create_RepVGG_D2se(nOut=256,  deploy=False):
    return RepVGG(num_blocks=[8, 14, 24, 1], nOut=nOut,
