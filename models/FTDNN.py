...
class FTDNN(nn.Module):
    ...
    def __init__(self, in_dim=30, nOut=512, **kwargs):
        '''
        ...
        self.layer12 = DenseReLU(4096, nOut)
        ...
        self.torchfb = torch.nn.Sequential(
            ...
            torchaudio.transforms.MelSpectrogram(
                ...
                n_mels=64))
#         self.lfcc = torch.nn.Sequential(
#             torchaudio.transforms.LFCC(
#                 sample_rate = 16000, n_filter = 512, n_lfcc= 40))
...
def MainModel(nOut=512, **kwargs):
    ...
    model = FTDNN(in_dim=n_mels, nOut=nOut, **kwargs)
    return model